...
$registros_telefone_all = buscarFaturas($pdo, $filtros) ?? [];

// 2. Calcular os totais para os cartões do dashboard
$totais = calcularTotaisFaturas($registros_telefone_all, 'telefone');
...
$total_registros = count($registros_telefone_all);
$pagination = new PaginationHelper($total_registros, $limit, $page);

// Paginar os registros
$offset = $pagination->getOffset();
$registros_telefone = array_slice($registros_telefone_all, $offset, $limit);
